...
('Emerald Ring', 1, 145.00, 72.50, 5, 'A beautiful emerald ring.', 'ER-2023', 'ER12346', TRUE, 'Emerald Imports Inc.', TRUE, 'https://via.placeholder.com/300x400?text=Emerald+Ring'),
('Diamond Ring', 1, 999.00, 600, 2, 'A beautiful diamond ring.', 'ER-xxx1', 'ERxxxx1', TRUE, 'Diamond A.S.', TRUE, 'https://via.placeholder.com/300x400?text=Diamond+Ring'),
('Secret Ring', 1, 1.00, 1, 1, 'This item is not visible.', 'ER-xxx2', 'ERxxxx2', TRUE, 'Not Produced Yet', TRUE, 'https://via.placeholder.com/300x400?text=Secret+Ring'),
('Vintage Silver Ring', 1, 90.00, 45.00, 8, 'A vintage-style silver ring.', 'VSR-2023', 'VSR12347', TRUE, 'Vintage Treasures Ltd.', TRUE, 'https://via.placeholder.com/300x400?text=Silver+Ring'),
